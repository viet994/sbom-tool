...
namespace Microsoft.Sbom.Api.Executors
{
    ...
    {
        public PackagesWalker(ILogger log, ComponentDetectorCachedExecutor componentDetector, IConfiguration configuration, ISbomConfigProvider sbomConfigs, IContext context)
